                        ...
                        <div className="rounded-3xl border border-border bg-card p-6 shadow-xl sm:p-8">
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <Button
                                    ...
                                    className="w-full gap-2 rounded-xl bg-foreground py-6 text-sm font-semibold leading-6 text-background shadow-sm hover:bg-foreground/90 hover:scale-[1.02] disabled:opacity-70 disabled:hover:scale-100"
                                >
                                    {isSubmitting ? (
                                        <>
